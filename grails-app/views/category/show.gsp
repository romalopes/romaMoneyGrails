	...
	<body>
		...
		<div id="show-category" class="content scaffold-show" role="main">
			...
			<ol class="property-list category">
				...
				<g:if test="${categoryInstance?.groupCategory}">
				<li class="fieldcontain">
					<span id="groupCategory-label" class="property-label"><g:message code="category.groupCategory.label" default="Group Category" /></span>
					
						<span class="property-value" aria-labelledby="groupCategory-label"><g:link controller="groupCategory" action="show" id="${categoryInstance?.groupCategory?.id}">${categoryInstance?.groupCategory?.encodeAsHTML()}</g:link></span>
